...
/*位置传感器*/
	...
	/*位置传感器更新函数*/		
		//失能位置传感器
		bool PositionSensorSetInavailable( uint8_t index, const double* addition_inf = 0, double TIMEOUT = -1 );
	
		//delay参数小于0则不会改变delay
		bool PositionSensorUpdatePositionGlobal( uint8_t index, vector3<double> position_Global, bool available, double delay = -1.0, double xy_trustD = -1, double z_trustD = -1, const double* addition_inf=0, double TIMEOUT = -1 );
		bool PositionSensorUpdatePosition( uint8_t index, vector3<double> position, bool available, double delay = -1.0, double xy_trustD = -1, double z_trustD = -1, const double* addition_inf=0, double TIMEOUT = -1 );
		bool PositionSensorUpdatePositionGlobalVel( uint8_t index, vector3<double> position_Global, vector3<double> vel, bool available, double delay = -1.0, double xy_trustD = -1, double z_trustD = -1, const double* addition_inf=0, double TIMEOUT = -1 );
		bool PositionSensorUpdatePositionVel( uint8_t index, vector3<double> position, vector3<double> vel, bool available, double delay = -1.0, double xy_trustD = -1, double z_trustD = -1, const double* addition_inf=0, double TIMEOUT = -1 );
		bool PositionSensorUpdateVel( uint8_t index, vector3<double> vel, bool available, double delay = -1.0, double xy_trustD = -1, double z_trustD = -1, const double* addition_inf=0, double TIMEOUT = -1 );
	/*位置传感器更新函数*/
/*位置传感器*/