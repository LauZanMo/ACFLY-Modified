...
void init_drv_Uart7()
{
	...
	//注册端口
	Port UartPort;
	UartPort.write = Write_Uart7;
	UartPort.wait_sent = WaitSent_Uart7;
	UartPort.lock = Lock_Uart7;
	UartPort.unlock = Unlock_Uart7;
	UartPort.read = Read_Uart7;
	UartPort.reset_rx = ResetRx_Uart7;
	UartPort.SetBaudRate = SetBaudRate_Uart7;
	PortRegister( 7, UartPort );
}
