...
ExtSPL06Detected:
	...
	while(1)
	{
		...
		if( pressure > 0 )
		{
			...
			PositionSensorUpdatePosition( external_baro_sensor_index , position , true , -1, -1,trust );
		}
	}
}
...
{
	xTaskCreate( ExtSPL06_Server, "ExtSPL06", 800, NULL, SysPriority_ExtSensor, NULL);
}
