...
void init_drv_Uart5()
{
	...
	//注册端口
	Port UartPort;
	UartPort.write = Write_Uart5;
	UartPort.wait_sent = WaitSent_Uart5;
	UartPort.lock = Lock_Uart5;
	UartPort.unlock = Unlock_Uart5;
	UartPort.read = Read_Uart5;
	UartPort.reset_rx = ResetRx_Uart5;
	UartPort.SetBaudRate = SetBaudRate_Uart5;
	PortRegister( 5, UartPort );
}
