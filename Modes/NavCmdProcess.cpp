	...
	switch(frame)
	{
		...
		case MAV_FRAME_BODY_OFFSET_NED:
		{
			...
			if( isvalid(params[3]) == false )
			{
				...
				ABvec.y = BodyHeading2ENU_y( safe_sqrt(params[5]*params[5] + params[4]*params[4])*100, 0, sin_Yaw, cos_Yaw );
				ABvec.z = -params[6]*100;
			}
			else
			{
				ABvec.x = BodyHeading2ENU_x( params[5]*100, params[4]*100, sin_Yaw, cos_Yaw );
				ABvec.y = BodyHeading2ENU_y( params[5]*100, params[4]*100, sin_Yaw, cos_Yaw );
				ABvec.z = -params[6]*100;
			}
			break;
		}
		...
		case MAV_FRAME_BODY_FLU:
		{
			...
			if( isvalid(params[3]) == false )
			{
				...
				ABvec.y = BodyHeading2ENU_y( safe_sqrt(params[4]*params[4] + params[5]*params[5])*100, 0, sin_Yaw, cos_Yaw );
				ABvec.z = params[6]*100;
			}
			else
			{
				ABvec.x = BodyHeading2ENU_x( params[4]*100, params[5]*100, sin_Yaw, cos_Yaw );
				ABvec.y = BodyHeading2ENU_y( params[4]*100, params[5]*100, sin_Yaw, cos_Yaw );
				ABvec.z = params[6]*100;
			}
			break;
		}
